...
function AboutUsCard() {
  return (
    <div className='w-full h-min rounded-md flex flex-col text-center items-center shadow-md shadow-gray-400 space-y-5 bg-white px-3 py-5 select-none'>
        ...
        <a className='py-2 px-4 bg-Classy rounded-md text-xs font-semibold text-Jet font-Roboto shadow-sm shadow-gray-500 transition-all duration-300 hover:bg-Jet hover:text-white ease-in-out' href="">READ MORE ABOUT US  {'>'} </a>
