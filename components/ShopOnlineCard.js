  ...
  return (
    <div className='w-full h-min rounded-md flex text-center items-center justify-center shadow-md shadow-gray-400 select-none relative bg-Jet'>
        <div className='flex flex-col items-center justify-center px-5 py-5 bg-transparent rounded-md space-y-7 z-20 '>
            ...
            <a className='py-2 px-4 bg-LimeGreen rounded-md text-xs font-semibold text-gray-900 font-Roboto shadow-sm shadow-gray-500 transition-all duration-300 hover:bg-white hover:brightness-100 hover:text-Jet border border-LimeGreen ease-in-out brightness-150 ' href="">SHOP NOW  {'>'}</a>
        </div>
