...
import DeliveryImage from '../images/Steak.jpeg'
  ...
  return (
    <div className='w-full h-min rounded-md flex text-center items-center shadow-md shadow-gray-400 select-none relative'>
        ...
        <div className='flex flex-col items-center justify-center px-5 py-5 bg-transparent rounded-md space-y-7 z-20 text-white'>
            ...
            <a className='py-2 px-4 bg-transparent rounded-md text-xs font-semibold text-white font-Roboto shadow-sm shadow-gray-500 transition-all duration-300 hover:bg-Jet hover:text-white ease-in-out border border-white' href="">TAKE A LOOK  {'>'}</a>
        </div>
        ...
        {/* Image Layer */}
        <div className='absolute w-full h-full rounded-md  z-0'><Image className='rounded-md z-0' layout='fill' src={DeliveryImage}/></div>
